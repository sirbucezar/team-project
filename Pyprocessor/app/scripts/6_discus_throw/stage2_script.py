...
# Constants
MODEL_PATH = os.path.join("disc_throwing", "stages", "stage2", "models", "discus_stage2.keras")
...
if __name__ == "__main__":
    test_video_path = os.path.join("disc_throwing", "stages", "stage2", "test_videos", "1_user2.mp4")
