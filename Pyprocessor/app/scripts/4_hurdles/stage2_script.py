...
# Constants
MODEL_PATH = os.path.join("hurdling", "stages", "stage2", "models", "hurdles_stage2.keras")
...
# Function to check if the hurdle is cleared
...
# Function to extract keypoints and check hurdle clearance
def extract_keypoints(video_path):
    """
    Extract keypoints for hurdle analysis and check if the first hurdle is cleared.
    """
    ...
    # Convert hurdle cleared status to a binary value
    return [[1 if hurdle_cleared else 0]]
...
if __name__ == "__main__":
    test_video_path = os.path.join("hurdling", "stages", "stage2", "test_videos", "0_user5_2.mp4")
