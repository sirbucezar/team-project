...
# Constants
MODEL_PATH = os.path.join("sprint_technique", "stages", "stage5", "models", "sprint_stage5.keras")
...
# Function to determine if the center of mass is leaning forward
...
def extract_keypoints(video_path):
    """
    Extract keypoints to analyze center of mass movement.
    """
    keypoints = []
    ...
    while cap.isOpened():
        ...
        if result.pose_landmarks:
            ...
            # Extract relevant keypoints for left and right sides
            ...
            keypoints.append([int(left_mass_forward), int(right_mass_forward)])
...
if __name__ == "__main__":
    test_video_path = os.path.join("sprint_technique", "stages", "stage5", "test_videos", "1_user2.mp4")
